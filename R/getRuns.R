...
#'
#' @param match.partial whether runs that partially overlap the specified ts range are included, Default: TRUE 
#'
#' @param motusTagID vector of Motus tag ID's used to filter the resulting dataframe, Default: c()
#'
#' @param ambigID vector of ambig ID's used to filter the resulting dataframe, Default: c()
#'
